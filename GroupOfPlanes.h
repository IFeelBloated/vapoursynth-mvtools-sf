...
auto Median3(int32_t a, int32_t b, int32_t c) {
	if (((b <= a) && (a <= c)) || ((c <= a) && (a <= b))) return a;
	else if (((a <= b) && (b <= c)) || ((c <= b) && (b <= a))) return b;
	else return c;
}

auto GetMedian(int32_t* vx, int32_t* vy, int32_t vx1, int32_t vy1, int32_t vx2, int32_t vy2, int32_t vx3, int32_t vy3) {
...
public:
	GroupOfPlanes(int32_t _nBlkSizeX, int32_t _nBlkSizeY, int32_t _nLevelCount, int32_t _nPel, int32_t _nMotionFlags, int32_t _nOverlapX, int32_t _nOverlapY, int32_t _nBlkX, int32_t _nBlkY, int32_t _xRatioUV, int32_t _yRatioUV, int32_t _divideExtra) {
