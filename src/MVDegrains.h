...
inline void useBlock(const uint8_t * &p, int32_t &np, double &WRef, bool isUsable, const MVClipBalls *mvclip, int32_t i, const MVPlane *pPlane, const uint8_t **pSrcCur, int32_t xx, const int32_t *nSrcPitch, int32_t nLogPel, int32_t plane, int32_t xSubUV, int32_t ySubUV, const float *thSAD) {
	if (isUsable) {
