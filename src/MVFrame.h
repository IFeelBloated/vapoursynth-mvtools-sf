...
public:
	MVPlane(int _nWidth, int _nHeight, int _nPel, int _nHPad, int _nVPad);
	~MVPlane();
...
class MVFrame {
	...
	int yRatioUV;
public:
	MVFrame(int nWidth, int nHeight, int nPel, int nHPad, int nVPad, int _nMode, int _xRatioUV, int _yRatioUV);
	~MVFrame();
...
class MVGroupOfFrames {
	...
	int yRatioUV;
public:
	MVGroupOfFrames(int _nLevelCount, int nWidth, int nHeight, int nPel, int nHPad, int nVPad, int nMode, int _xRatioUV, int yRatioUV);
	~MVGroupOfFrames();
