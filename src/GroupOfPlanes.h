...
public:
	...
	void SearchMVs(MVGroupOfFrames *pSrcGOF, MVGroupOfFrames *pRefGOF,
		SearchType searchType, int32_t nSearchParam, int32_t _PelSearch, double _nLambda, double _lsad, int32_t _pnew, int32_t _plevel, bool _global, int32_t *out, int16_t * outfilebuf, int32_t fieldShift, DCTClass * DCT, int32_t _pzero, int32_t _pglobal, double badSAD, int32_t badrange, bool meander, int32_t *vecPrev, bool tryMany, SearchType coarseSearchType);
	...
	void RecalculateMVs(MVClipBalls &mvClip, MVGroupOfFrames *pSrcGOF, MVGroupOfFrames *pRefGOF,
		SearchType _searchType, int32_t _nSearchParam, double _nLambda, int32_t _pnew, int32_t *out, int16_t * outfilebuf, int32_t fieldShift, double thSAD, DCTClass * DCT, int32_t smooth, bool meander);
};
