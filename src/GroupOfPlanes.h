...
class GroupOfPlanes {
    ...
    void SearchMVs(MVGroupOfFrames *pSrcGOF, MVGroupOfFrames *pRefGOF,
            SearchType searchType, int nSearchParam, int _PelSearch, float _nLambda, float _lsad, int _pnew, int _plevel, bool _global, int *out, short * outfilebuf, int fieldShift, DCTClass * DCT, int _pzero, int _pglobal, float badSAD, int badrange, bool meander, int *vecPrev, bool tryMany, SearchType coarseSearchType);
