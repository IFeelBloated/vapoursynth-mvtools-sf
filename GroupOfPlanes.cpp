...
void GroupOfPlanes::SearchMVs(MVGroupOfFrames *pSrcGOF, MVGroupOfFrames *pRefGOF,
        SearchType searchType, int nSearchParam, int nPelSearch, float nLambda,
        float lsad, int pnew, int plevel, bool global,
        int *out, short *outfilebuf, int fieldShift, DCTClass * _DCT,
        int pzero, int pglobal, float badSAD, int badrange, bool meander, int *vecPrev, bool tryMany,
